...
class Test(TestCase):
    def test_extract_handler(self):
        ...
        extract_handler(resource_uuid, "Test FAIR", "data/files/Riv2",
                        True, "multiple", "This publication is a resource in GeoEDF Portal. (Test)", "kw1")
    ...
    def test_delete_subject(self):
        client = app_search_client()
        subject_id = "959c72db-5791-47c9-8547-b605f2a6666a"
